# $${\color{lightgreen}Brescia \ Green \ Park}$$
...
## $${\color{lightgreen}Visione \ del \ progetto}$$
...
## $${\color{lightgreen}Analisi \ e \ preparazione}$$
...
## $${\color{lightgreen}Requisiti \ funzionali}$$
...
- **10 punti** per ogni ora di sosta completata, con moltiplicatore **x1,2** per i veicoli elettrici.
...
## $${\color{lightgreen}Requisiti \ non \ funzionali}$$
...
## $${\color{lightgreen}Funzionalità \ principali}$$
 
### $${\color{lightblue}Per \ l'utente}$$
...
### $${\color{lightblue}Per \ l'amministratore}$$
...
## $${\color{lightgreen}Architettura \ tecnica}$$
 
- **$${\color{lightblue}Frontend}$$:** React 18 con Vite e React Router v6.
- **$${\color{lightblue}Styling}$$:** Tailwind CSS con animazioni CSS personalizzate per tema, modal e toast.
- **$${\color{lightblue}BaaS}$$:** Supabase — database PostgreSQL, autenticazione (email e Google OAuth), canali Realtime e Row Level Security.
- **$${\color{lightblue}Mappa}$$:** Leaflet + OpenStreetMap; Leaflet Routing Machine per i percorsi GPS.
- **$${\color{lightblue}Grafici}$$:** Recharts per la dashboard admin.
- **$${\color{lightblue}Altro}$$:** Flatpickr per il selettore date localizzato in italiano.
...
## $${\color{lightgreen}Installazione}$$
...
## $${\color{lightgreen}Team}$$
 
- $${\color{lightblue}Togni \ Alessandro}$$
- $${\color{lightblue}Singh \ Manrayet}$$
- $${\color{lightblue}Ponti \ Daniele}$$
